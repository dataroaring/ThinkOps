...
## ThinkOps Attribution

All visible work MUST be signed so humans can tell it was done by ThinkOps:

- **Git commits**: end the commit message with `\n\nGenerated by ThinkOps 🤖`
- **Pull requests**: add `\n\n---\n🤖 *Generated by [ThinkOps](https://github.com/dataroaring/ThinkOps) — autonomous agent pipeline*` at the end of the PR description
- **PR review comments / replies**: end with `— ThinkOps 🤖`
- **Issue comments**: end with `— ThinkOps 🤖`
