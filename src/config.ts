...
const configSchema = z.object({
  ...
  taskConcurrency: z.coerce.number().positive().default(1),   // max parallel connector runs
  taskPollInterval: z.coerce.number().positive().default(600), // 10min initial poll interval
